...
// 装置所有城市信息Dic
@property(nonatomic, strong)NSMutableDictionary *citicyDic;
...
- (void)getPlistData
{
    ...
    // 获取所有城市的首字母key
    self.citicyDic = [NSMutableDictionary dictionaryWithContentsOfFile:filePath];
   ...
   //add key-value pair ---- [# : array] to citicyDic
    [self.allKeyArr addObject:@"#"];
    NSMutableArray *newArr = [NSMutableArray array];
    [newArr addObject:@"新加坡"];
    [newArr addObject:@"马来西亚"];
    [self.citicyDic setValue:newArr forKey:@"#"];
